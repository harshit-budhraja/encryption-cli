...
class Encryption {
     ...
     * create your own Encryption instance using the Encryption.Builder
     */
     ...
     *
     * @throws UnsupportedEncodingException       if the Builder char set name is not supported or if
     *                                            the Builder char set name is not supported
